...
public class StoreExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> NotFoundStoreExceptionHandler(Exception e){

        HttpHeaders responseHeader = new HttpHeaders();
        HttpStatus httpStatus = HttpStatus.BAD_REQUEST;

        log.info("Advice : NotFoundStoreExceptionHandler");
    ...
    @ExceptionHandler(AlreadyExistsStoreException.class)
    public ResponseEntity<Map<String, String>> AlreadyExistsStoreExceptionHandler(Exception e){

        HttpHeaders responseHeader = new HttpHeaders();
        HttpStatus httpStatus = HttpStatus.BAD_REQUEST;

        log.info("Advice : AlreadyExistsStoreExceptionHandler");
